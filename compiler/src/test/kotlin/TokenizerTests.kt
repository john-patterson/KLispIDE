...
class TokenizerTests {
    ...
    inner class ListTests {
        ...
        fun `tokenizes function invocation with args`() {
            ...
            assertEquals(Token("g", TokenType.IDENTIFIER, 1), result[1])
            assertEquals(Token("1", TokenType.NUMERIC, 3), result[2])
            assertRightParen(4, result[3])
        }

        private fun assertLeftParen(pos: Int, leftParen: Token) {
            assertEquals(Token("(", TokenType.LEFT_PARENS, pos), leftParen)
        }

        private fun assertRightParen(pos: Int, leftParen: Token) {
            assertEquals(Token(")", TokenType.RIGHT_PARENS, pos), leftParen)
        }
    }
    ...
    inner class ReservedKeywordsTests {
        ...
        fun `classifies if`() {
            ...
            assertEquals(2, result.size)
            assertEquals(Token("if", TokenType.IF, 0), result[0])
            assertEquals(Token("IF", TokenType.IF, 3), result[1])
        }
        ...
        fun `classifies let`() {
            ...
            assertEquals(2, result.size)
            assertEquals(Token("let", TokenType.LET, 0), result[0])
            assertEquals(Token("LET", TokenType.LET, 4), result[1])
        }
        ...
        fun `classifies fun`() {
            ...
            assertEquals(2, result.size)
            assertEquals(Token("fun", TokenType.FUN, 0), result[0])
            assertEquals(Token("fUn", TokenType.FUN, 4), result[1])
        }
        ...
        fun `classifies true`() {
            ...
            assertEquals(2, result.size)
            assertEquals(Token("true", TokenType.BOOLEAN, 0), result[0])
            assertEquals(Token("tRUe", TokenType.BOOLEAN, 5), result[1])
        }
        ...
        fun `classifies false`() {
            ...
            assertEquals(2, result.size)
            assertEquals(Token("false", TokenType.BOOLEAN, 0), result[0])
            assertEquals(Token("FalsE", TokenType.BOOLEAN, 6), result[1])
        }
    }
    ...
    inner class SymbolClassificationTests {
        ...
        fun `classifies symbols`() {
            ...
            assertEquals(Token("abc", TokenType.IDENTIFIER, 0), result[0])
            assertEquals(Token("abc123", TokenType.IDENTIFIER, 4), result[1])
            assertEquals(Token("123ABc", TokenType.IDENTIFIER, 11), result[2])
            assertEquals(Token("....", TokenType.IDENTIFIER, 18), result[3])
            assertEquals(Token("___%&", TokenType.IDENTIFIER, 23), result[4])
        }
    }
    ...
    inner class NumberClassificationTests {
        ...
        fun `classifies positive integer`() {
            ...
            assertEquals(Token("123", TokenType.NUMERIC, 0), result[0])
        }
        ...
        fun `classifies zero`() {
            ...
            assertEquals(1, result.size)
            assertEquals(Token("0", TokenType.NUMERIC, 0), result[0])
        }
        ...
        fun `classifies positive floating number`() {
            ...
            assertEquals(1, result.size)
            assertEquals(Token("1.23", TokenType.NUMERIC, 0), result[0])
        }
        ...
        fun `classifies positive floating zero`() {
            ...
            assertEquals(1, result.size)
            assertEquals(Token("0.00", TokenType.NUMERIC, 0), result[0])
        }
